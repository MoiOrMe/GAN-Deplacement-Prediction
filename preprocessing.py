...
class ETHDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        sample = {
            ...
            "obs_rel": torch.tensor(obs_rel_norm, dtype=torch.float32),     # coordonnées relatives observées
            "pred_rel": torch.tensor(pred_rel_norm, dtype=torch.float32)    # coordonnées relatives prédites
        }
